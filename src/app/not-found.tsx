  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] w-full relative flex items-center justify-center p-4 pb-24 font-mono overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute inset-0 bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_50%,black)] dark:hidden"></div>
        </div>
        ...
        ">
          ...
          <div className="flex items-center justify-between px-3 py-3 md:px-4 bg-gray-50 dark:bg-[#0c0c0e] border-b border-gray-200 dark:border-zinc-800 transition-colors">
             <div className="flex items-center gap-2 overflow-hidden">
                <div className="flex items-center gap-2 px-3 py-1 bg-white dark:bg-[#09090b] rounded-t-md text-xs md:text-sm border-t-2 transition-colors
                                ...
                                dark:text-zinc-200 dark:border-zinc-500 font-medium truncate
                ">
                   <FileX size={14} className="shrink-0" />
                   <span className="truncate">404.tsx</span>
                   <span className="text-gray-400 hover:text-gray-600 dark:text-zinc-400 dark:hover:text-zinc-100 cursor-pointer text-xs ml-2">x</span>
                </div>
             </div>
          </div>
          ...
          <div className="p-3 md:p-6 overflow-x-auto bg-white dark:bg-[#09090b] transition-colors">
             <div className="flex text-xs md:text-base leading-relaxed w-max md:w-full">
                ...
                <div className="flex flex-col text-right select-none pr-3 md:pr-4 border-r mr-3 md:mr-4 font-mono transition-colors
                                ...
                                dark:text-zinc-700 dark:border-zinc-800
                ">
                ...
                <div className="font-mono">
                   ...
                   <div>
                      ...
                      <span className="text-[#374151] dark:text-zinc-100 font-bold">NotFound</span>
                      <span className="text-gray-500 dark:text-zinc-600">{`() {`}</span>
                   </div>
                   ...
                   <div className="pl-8 md:pl-12">
                      ...
                      <span className="text-gray-500 dark:text-zinc-600">=</span>
                      <span className="text-[#42CF8E] dark:text-zinc-400 dark:italic">&quot;/&quot;</span>
                      <span className="text-gray-500 dark:text-zinc-600">&gt;</span>
                   </div>
                   ...
                   <div className="pl-12 md:pl-16">
                      <Link href="/">
                        <span className="cursor-pointer font-bold border-b border-dashed pb-0.5 transition-all
                                        ...
                                        dark:text-zinc-200 dark:border-zinc-500 dark:hover:text-white dark:hover:border-white
                        ">
                          Go back home
                        </span>
                      </Link>
          ...
          <div className="border-t p-3 md:p-4 font-mono text-xs md:text-sm transition-colors
                          ...
                          dark:border-zinc-800 dark:bg-[#0c0c0e]
          ">
             ...
             <div className="text-red-600 dark:text-zinc-200 font-bold break-words whitespace-pre-wrap">
                Error: Module not found: Can&apos;t resolve requested URL.
             </div>
             <div className="mt-1 text-gray-600 dark:text-zinc-500 break-words whitespace-pre-wrap">
